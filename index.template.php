...
<html><head>
	...
	<script>
		(function () {
			var theme = 'light';
			try {
				var savedTheme = localStorage.getItem('rbdex-theme');
	...
	<link rel="stylesheet" href="/theme/theme-toggle.css?" />
		...
		<div class="header">
			...
			<ul class="nav nav-theme">
				<li>
					...
					<select id="theme-select" class="textbox theme-select" aria-label="Theme">
